...
public class StartDiscoverService extends IntentService implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
	...
	public StartDiscoverService(String name) {
		super(name);
	}
	
	public StartDiscoverService() {
		super("name");
	}
