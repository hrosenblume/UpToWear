...
public class PullEventsService extends IntentService implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
	...
	public PullEventsService(String name) {
		super(name);
	}
	
	public PullEventsService() {
		super("name");
	}
